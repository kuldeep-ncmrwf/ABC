...
png("ukmo_scrs_WC_2007_18.png", units="in", width=5, height=5, res=400)
...
plot(x,D1$V9,type='l',col='black',ylim=c(0,0.6),cex.axis=1.2,xaxt="n",main="",lwd=1.5,las=2)
lines(x,D4$V9,col='red',lwd=1.5)

plot(x,D2$V9,type='l',col='black',ylim=c(0,0.6),cex.axis=1.2,xaxt="n",yaxt="n",main="",lwd=1.5)
lines(x,D5$V9,col='red',lwd=1.5)

plot(x,D3$V9,type='l',col='black',ylim=c(0,0.6),cex.axis=1.2,xaxt="n",yaxt="n",main="",lwd=1.5)
